...
- かき終わってから典型コメントを読んだ．
    ...
    - これいいな．だいぶ短く．すっきりした形でループが書ける．
    - parentとisLeftの二つを渡すのではなく，参照の参照を渡すことで分岐せずに書ける．
    - ん〜でもちょっと頭が追いつかない感じがある．
    - LLM解説させたらわかった気になった
    - &と*をごっちゃにしていた感じがある．個人的にnilポインタを `&(nilポインタ)` という操作ができないような気がしていたが，できないのは `*(nilポインタ)` のほうだった
        - https://go.dev/play/p/_wJJOw01eSY
